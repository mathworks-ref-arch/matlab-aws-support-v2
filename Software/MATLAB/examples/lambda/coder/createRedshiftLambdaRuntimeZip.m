function zipFileName = createRedshiftLambdaRuntimeZip(functionName, args)
...
cfg.CustomInclude = './redshift-lambda-custom-runtime';
...
copyAndSetPermission('./redshift-lambda-custom-runtime/bootstrap', './bootstrap', '755');
copyAndSetPermission('./redshift-lambda-custom-runtime/function.sh', './function.sh', '755');
...
for idx = 1:numArgs
    [argType, argName] = strtok(argList{idx});
    argName = sprintf('arg%d', idx);
